  ...
  return (
    <header className="text-center my-8">
      ...
      <div className="flex items-center justify-center">
        <h1 className="text-4xl font-bold text-blue-600 bg-gradient-to-r from-blue-900 to-blue-600 bg-clip-text text-transparent">Welcome To Fuel Price Dashboard</h1>
      </div>
